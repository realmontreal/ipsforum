...
{	
	...
	public static function defaultConstants()
	{
		...
		if ( isset( $_SERVER['IPS_CIC'] ) )
		{
			...
			{
				$uniqueKey = preg_match( '/^\/var\/www\/html\/(.+?)$/i', __DIR__, $matches ) ? str_replace( '/', '', $matches[1] ) : mb_substr( md5( 'ips_crew' . '$Rev: 3023$'), 10, 10 );
			}
		}
		else
		{
			$uniqueKey = mb_substr( md5( 'ips_crew' . '$Rev: 3023$'), 10, 10 );
		}
		...
		return array(
			...
			// to change them.
				...
				'CACHEBUST_KEY'		=> mb_substr( md5( 'ips_crew' . '$Rev: 3023$'), 10, 10 ),
	...
	{
		/* Do we even have a license key? Nope, we don't! */
		if ( !\IPS\Settings::i()->ipb_reg_number ) {
			\IPS\Db::i()->update( 'core_sys_conf_settings', array( 'conf_value' => '16BF-9C65-B3A6-1337' ), array( 'conf_key=?', 'ipb_reg_number' ) );
			\IPS\Settings::i()->ipb_reg_number	= '16BF-9C65-B3A6-1337';							
		}

		$response = array(
				'key' => \IPS\Settings::i()->ipb_reg_number,
				'active' => \IPS\Settings::i()->ipb_license_active,
				'cloud' => \IPS\Settings::i()->ipb_license_cloud,
				'url' => \IPS\Settings::i()->ipb_license_url,
				'test_url' => \IPS\Settings::i()->ipb_license_test_url,
			 	'expires' => \IPS\Settings::i()->ipb_license_expires,
			 	'products' => array(
			 	 	'forums' => \IPS\Settings::i()->ipb_license_product_forums,
			 	 	'calendar' => \IPS\Settings::i()->ipb_license_product_calendar,
			 	 	'blog' => \IPS\Settings::i()->ipb_license_product_blog,
			 	 	'gallery' => \IPS\Settings::i()->ipb_license_product_gallery,
			 	 	'downloads' => \IPS\Settings::i()->ipb_license_product_downloads,
			 	 	'cms' => \IPS\Settings::i()->ipb_license_product_cms,
			 	 	'nexus' => \IPS\Settings::i()->ipb_license_product_nexus,
			 	 	'spam' => FALSE,
			 	 	'copyright' => \IPS\Settings::i()->ipb_license_product_copyright,
		 		),
			 	'chat_limit' => \IPS\Settings::i()->ipb_license_chat_limit,
			 	'support' => \IPS\Settings::i()->ipb_license_support,
			);
